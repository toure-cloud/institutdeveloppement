...
urlpatterns = [
    ...
    path("activites/", views.activite, name="activite"),   # Liste des activités
    path("activites/<int:id>/", views.activite_detail, name="activite_detail"),
    path("presentation/", views.page_view, {"page_name": "presentation"}, name="presentation"),
    path("travaux/", views.page_view, {"page_name": "travaux"}, name="travaux"),
    path("inscription/", views.page_view, {"page_name": "inscription"}, name="inscription"),
   ...
   path('password-reset/',
    ...
    path("candidat/inscription/<str:formation_type>/", views.inscription_formation, name="inscription_formation"),
    path("candidat/login/", views.candidat_login_page, name="candidat_login"),
    ...
    path("candidat/details-formation/", views.details_formation, name="details_formation"),
    ...
    path("api/", include([
    path("team-members/<slug:slug>/", views.TeamMemberAPIView.as_view(), name="team-member-detail"),
])),
